...
import { FaUser, FaAmbulance, FaHospital } from "react-icons/fa";
...
const DriverMap: React.FC<MapComponentProps> = ({
  apiKey,
  ambulanceLocation,
  userLocation,
  hospitalLocation,
  ...
  useEffect(() => {
    ...
    const initialCenter = userLocation
      ...
      : { lat: 27.7172, lng: 85.324 }; // Default Kathmandu
  ...
  useEffect(() => {
    ...
    const userLatLng = new google.maps.LatLng(userLocation[1], userLocation[0]);
    ...
    hospitalMarkerRef.current = new google.maps.Marker({
      ...
      icon: {
        url: getIcon(FaHospital, "green", 30),
        scaledSize: new google.maps.Size(40, 40),
      },
    });
